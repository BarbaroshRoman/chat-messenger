...
const dialogsSlice = createSlice({
    ...
    reducers: {
        ...
        pinningDialog(state, action) {
            ...
            state.dialogsList = [...state.dialogsList].filter(el => el.dialogId !== action.payload.dialogId);
        },
...
export const {creatingDialog, deletingDialog, dialogsSorting, pinningDialog, unpiningDialog} =
